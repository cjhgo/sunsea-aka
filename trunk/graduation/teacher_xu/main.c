...
void show_pic_2 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran24_32_16);
void show_pic_3 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_4 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_5 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_6 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, int portion, callback_t tran_24_32_16);
void show_pic_7 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, int portion, callback_t tran_24_32_16);
void show_pic_8 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_9 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_10 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_11 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_12 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, int portion, callback_t tran24_32_16);
void show_pic_13 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
void show_pic_14 (unsigned char *pic_buf, int init_x, int init_y, int leng_w,
		int leng_h, callback_t tran_24_32_16);
	...
	while (img_tmp != NULL)
	{
		...
		switch (style_num)
		{
			case 1:
				...
				break;
			case 2:
				show_pic_2 (buf, init_x - pic_w, init_y - pic_h, pic_w, pic_h,tran24_32_16);
				break;
			case 3:
